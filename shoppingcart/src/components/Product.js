        ...
        return (
          <div className="bg">
            <div style={{padding:"10px"}}>
                {/* {this.productList()} */}
                <img className="prod" src={this.state.products.productImage} style={{width:"500px", height:"500px"}}  />
                
                <div className="img">
                <label>Product Name:</label>
                {this.state.products.productName}<br/>
                <label>Price:</label>
                {this.state.products.price}<br/>
                <label>Description:</label>
                {this.state.products.description}<br/>
                <label>Add quantity:</label>
                <input type="number" min="0" max="5" value={this.state.quant} onChange={this.changeHandle}/><br/>
                {console.log(this.state.quant)}
                <button className="btn-success" style={{borderRadius:"5px"}} onClick={this.abc(this.state.products._id,this.state.products.quant)}>Add to Cart</button>
                </div>
            </div>
            </div>
        )
